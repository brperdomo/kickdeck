// This is a simplified version of UserDashboard for direct testing
import React, { useEffect } from 'react';
import { useAuth } from '@/hooks/use-auth';

export default function DirectUserDashboard() {
  const { user } = useAuth();

  useEffect(() => {
    console.log('DirectUserDashboard mounted with user:', user);
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <h1 className="text-3xl font-bold mb-6">Direct Member Dashboard</h1>
