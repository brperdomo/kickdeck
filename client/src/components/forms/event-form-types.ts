...
export type EventTab = 'information' | 'age-groups' | 'brackets' | 'scoring' | 'complexes' | 'settings' | 'banking' | 'administrators' | 'game-cards';
...
export const TAB_ORDER: EventTab[] = ['information', 'age-groups', 'brackets', 'scoring', 'complexes', 'settings', 'banking', 'administrators', 'game-cards'];
...
export const eventInformationSchema = z.object({
  ...
  applicationDeadline: z.string().min(1, "Registration deadline is required"),
