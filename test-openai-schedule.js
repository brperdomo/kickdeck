...
const { SoccerSchedulerAI } = require('./server/services/openai-service');
...
// Test the OpenAI schedule generation
async function testOpenAIScheduleGeneration() {
  try {
