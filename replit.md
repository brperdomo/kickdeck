...
- **Core Features**:
    ...
    - **Enhanced Bracket Creation Engine**: Comprehensive team assignment interface with manual assignment, seeding, proper flight name formatting, and placeholder team functionality. Supports dynamic creation of virtual Pool A/B brackets for crossplay flights.
