/**
 * Registration Receipt Email Template Script
 * 
 * This script creates the registration receipt email template
 * for sending transaction details to registration submitters.
 */

const { db } = require('./dist/db/index');
const { emailTemplates } = require('./dist/db/schema');
...
if (process.argv[1].endsWith('create-registration-receipt-template.js')) {
  createRegistrationReceiptTemplate()
    .then(result => {
...
module.exports = { createRegistrationReceiptTemplate };